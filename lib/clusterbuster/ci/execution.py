...
"""Per-job argv construction and subprocess invocation of the ``clusterbuster`` driver."""
...
def run_clusterbuster_job(
    ...
    *,
    ...
    if status == 0 and jobdir and tmp_jobdir:
        ...
        # already under ``jobdir`` if the driver finalized in place. Rename when needed.
