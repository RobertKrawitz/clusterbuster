...
"""Smoke tests for lib/clusterbuster/workload_options (no cluster required)."""
...
def test_parse_deployment_targets():
    from clusterbuster.workload_options.cases import parse_deployment_targets
...
def test_iter_case_rows_pod(cases_path: Path):
    from clusterbuster.workload_options.cases import iter_case_rows
...
def test_emit_loader_tsv_lines(cases_path: Path):
    from clusterbuster.workload_options.cases import emit_loader_tsv_lines
...
def test_run_config_defaults():
    from clusterbuster.workload_options.runner import RunConfig
