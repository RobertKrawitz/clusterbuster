...
run ./clusterbuster -f fio $POD --workload-runtime=25 --fio-patterns=read --fio-absolute-filesize=1Gi
...
run ./clusterbuster -f fio $VM --workload-runtime=30 --fio-patterns=read --fio-absolute-filesize=1Gi
